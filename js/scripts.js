$(document).ready(function () {
  ...
  $("#rsvp-form").on("submit", function (e) {
    ...
    if (MD5($("#invite_code").val()) !== "cdadd6d9142d6d284e480028e18163c1") {
      ...
      $.ajax({
        url: "https://script.google.com/macros/s/AKfycbzrU9F1vZQSWBR3pCJVME2oZdmrrua4LQwipusv9_3mSunaNsYGLxqnIpJQixvSfaPk2g/exec",
        type: "POST",
        data: data,
...
// Google map
function initMap() {
  var location = { lat: 10.7557295, lng: 106.6903722 };
...
function initBBSRMap() {
  var la_fiesta = { lat: 10.7557295, lng: 106.6903722 };
  var map = new google.maps.Map(document.getElementById("map-canvas"), {
    zoom: 15,
    center: la_fiesta,
    scrollwheel: false,
